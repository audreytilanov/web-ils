    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header">
            ...
            <a href="{{Route('food.add')}}"><div class="btn btn-primary">Add Content Food</div></a>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-striped table-responsive-sm">
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    <a href="{{Route('food.edit', $content->id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                    <div class="sweetalert">
                      <form action="{{Route('food.delete', $content->id)}}" method="POST">
                        @csrf
