    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header">
            ...
            <a href="{{Route('wisata.add')}}"><div class="btn btn-primary">Add Content Wisata Hiburan</div></a>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-striped table-responsive-sm">
              ...
              <tr>
                ...
                <td><img src="{{URL::asset('asset/wisata-hiburan/'.$content->image)}}" alt="{{ $content->image }}" width="100px" height="auto"></td>
