  ...
  <div class="container-fluid">
    <div class="page-titles">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">Content Intro 2</a></li>
      </ol>
    </div>
    <!-- row -->
      ...
      <div class="col-xl-12 col-xxl-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Edit List Content Intro 2</h4>
          </div>
          <div class="card-body">
            <form action="{{Route('save_editcontentIntro2',['id' => $content->id])}}" method="POST" enctype="multipart/form-data" id="step-form-horizontal" class="step-form-horizontal" >
              @csrf
              <div>
                <section>
                  <div class="row">
                    ...
                    <div class="col-lg-12 mb-2">
                        <div class="form-group">
                            ...
                            <img src="{{URL::asset('asset/intro2/'.$content->image)}}" class="img-thumbnail row mb-3" id="update_image_nasabah2" style="height:300px; width:400px;">
                    ...
                    <div class="col-lg-12 mb-2">
                        <div class="form-group">
                          ...
                          <div class="dropdown bootstrap-select form-control dropup">
                                @if ($count == 1)
                                    <h5 class="text-danger">Status Primary Hanya Untuk 1 Data</h5>
                                ...
                                @else
                                    <select name="status" id="status" class="form-control" tabindex="-98">
                                        ...
                                        <option value="primary" @if ($content->status == "primary") {{'selected="selected"'}} @endif >Primary</option>
                                    </select>
                                @endif
                          </div>
                        </div>
                    ...
                    <div class="col-lg-12 mb-3">
                      ...
                      <a href="{{Route('list_intro2')}}" class="btn btn-info" style="float:left;">Back</a>   
                    </div>
                  </div>
                </section>
              </div>
