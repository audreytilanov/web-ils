      ...
      <div class="col-xl-12 col-xxl-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Add Gallery Video</h4>
          </div>
          <div class="card-body">
            <form action="{{Route('video.add.save')}}" method="POST"  enctype="multipart/form-data" id="step-form-horizontal" class="step-form-horizontal">
              @csrf
              <div>
                <section>
                  <div class="row">
                    ...
                    <div class="col-lg-12 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control-file" id="link_yt" name="link_yt" required>
                        </div>
                    </div>
