    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header">
            ...
            <a href="{{Route('desa.add')}}"><div class="btn btn-primary">Add Content Desa</div></a>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-striped table-responsive-sm">
              ...
              <tr>
                ...
                <td><img src="{{URL::asset('asset/desa/'.$content->image)}}" alt="{{ $content->image }}" width="100px" height="auto"></td>
                ...
                <td>
                  <div class="d-flex">
                    <a href="{{Route('desa.edit', $content->id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                    <div class="sweetalert">
                      <form action="{{Route('desa.delete', $content->id)}}" method="POST">
                        @csrf
