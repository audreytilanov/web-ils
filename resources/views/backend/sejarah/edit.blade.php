  ...
  <div class="container-fluid">
    <div class="page-titles">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">Content Sejarah</a></li>
      </ol>
    </div>
    <!-- row -->
      ...
      <div class="col-xl-12 col-xxl-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Edit List Content Sejarah</h4>
          </div>
          <div class="card-body">
            <form action="{{Route('sejarah.edit.save',['id' => $content->id])}}" method="POST" enctype="multipart/form-data" id="step-form-horizontal" class="step-form-horizontal" >
              @csrf
              <div>
                <section>
                  <div class="row">
                    <div class="col-lg-12 mb-2">
                        <div class="form-group">
                          <label class="text-label">Header*</label>
                          <input type="text" class="form-control" id="header" name="header" aria-describedby="inputGroupPrepend2" value="{{$content->header}}" required>
                        </div>
                    </div>
                    <div class="col-lg-12 mb-2">
                        <div class="form-group">
                    ...
                    <div class="col-lg-12 mb-2">
                        <div class="form-group">
                            ...
                            <img src="{{URL::asset('asset/sejarah/'.$content->image)}}" class="img-thumbnail row mb-3" id="image" style="height:300px; width:400px;">
                    ...
                    <div class="col-lg-12 mb-3">
                      ...
                      <a href="{{Route('sejarah.index')}}" class="btn btn-info" style="float:left;">Back</a>   
                    </div>
                  </div>
                </section>
              </div>
