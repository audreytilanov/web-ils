    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header">
            ...
            <a href="{{Route('add_content')}}"><div class="btn btn-primary">Add List Content</div></a>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-striped table-responsive-sm">
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    <a href="{{Route('edit_content', $content->id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
