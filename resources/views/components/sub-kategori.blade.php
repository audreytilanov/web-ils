...
<div class="section-header"  data-aos="fade-right">
  <h3 class="section-title" style="margin-bottom: 40px;">Destinasi Wisata</h3>
  <!-- <img src="../asset/images/wave.svg" class="wave" alt="wave" /> -->
</div>

<div class="padding-30 rounded bordered" data-aos="fade-right" data-aos-delay="200">
  <div class="row gy-5">
    <div class="col-sm-6">
      <!-- post -->
      <div class="post"  >
          <div class="thumb rounded">
              <a href="category.html" class="category-badge position-absolute">Denpasar</a>
              <!-- <span class="post-format">
                  <i class="icon-picture"></i>
              </span> -->
              <a href="blog-single.html">
                  <div class="inner">
                      <img src="../asset/images/posts/editor-lg-1.png" alt="post-title" />
                  </div>
              </a>
          </div>
          <ul class="meta list-inline mt-4 mb-0">
              <li class="list-inline-item"><a href="#"><img src="../asset/images/other/author-sm.png" class="author" alt="author"/>ILS TI</a></li>
