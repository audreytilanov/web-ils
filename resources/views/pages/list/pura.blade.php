          ...
          <div class="col-md-6 col-sm-6">
            ...
            <div class="post post-list clearfix">
              <div class="thumb rounded">
                <a href="{{ route('pura.detail', ['slug'=>$content->slug]) }}">
                  <div class="inner">
                    <img src="{{ URL::asset('asset/pura/'.$content->image1) }}" alt="post-title" />
                  </div>
                </a>
              </div>
              <div class="details">
                ...
                <h5 class="post-title"><a href="{{ route('pura.detail', ['slug'=>$content->slug]) }}">{{ $content->title }}</a></h5>
