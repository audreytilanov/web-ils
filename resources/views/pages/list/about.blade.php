      ...
      <div class="col-md-12 col-sm-12">
        ...
        <div class="post post-list clearfix">
          ...
          <div class="details">
            ...
            <h5 class="post-title">Tentang Medan Vista Tour</h5>
            <p class="excerpt mb-0">Medan Vista Tour adalah salah satu penyedia jasa pelayanan pariwisata di medan yang menjadi salah satu penyedia paket medan tour, kami beroperasi mulai dari tahun 2014 silam, tidak terasa sudah hampir 3 tahun kami malakukan kegiatan ini. ada banyak paket MEDAN TOUR yang kami sediakan untuk anda semua. tentu saja dengan harga yang bersahabat dan rasional kami akan menemani perjalanan wisata anda.
