          ...
          <div class="col-md-6 col-sm-6">
            ...
            <div class="post post-list clearfix">
              <div class="thumb rounded">
                <a href="{{ route('pembangunan.detail', ['slug'=>$content->slug]) }}">
                  <div class="inner">
                    <img src="{{ URL::asset('asset/pembangunan/'.$content->image1) }}" alt="post-title" />
                  </div>
                </a>
              </div>
              <div class="details">
                <ul class="meta list-inline mb-3">
                  <li class="list-inline-item"><a style="cursor:default;"><img src="{{ URL::asset('asset/images/other/author-sm.png')}}" class="author" alt="author"/>ILS TI</a></li>
                ...
                <h5 class="post-title"><a href="{{ route('pembangunan.detail', ['slug'=>$content->slug]) }}">{{ $content->title }}</a></h5> 
